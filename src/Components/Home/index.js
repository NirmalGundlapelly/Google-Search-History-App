...
class Home extends Component {
  state = {inputText: '', historyList: initialHistoryList}
  ...
  deleteListItem = id => {
    ...
    const deletedItemList = historyList.filter(eachItem => eachItem.id !== id)
    console.log(id)
    this.setState({historyList: deletedItemList})
  }
